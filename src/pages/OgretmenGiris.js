        ...
        if (this.state.email == "" || this.state.password == "") {
            ...
            firebase.auth().signInWithEmailAndPassword(this.state.email, this.state.password)
                .then((res) => {
                    ...
                    this.props.navigation.navigate('OgretmenAnaSayfa')
                })
                .catch((res) => {
                    this.setState({
                        isLoading: false,
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.baslikInfo}>
                    <Text style={styles.baslik}>ÖĞRETMEN GİRİŞ EKRANI</Text>
                </View>
                ...
                <TouchableOpacity style={styles.girisButon}
                    //GİRİŞ BUTONUNA TIKLANDIKTAN SONRA NEREYE GİDECEĞİ YAPILMADI
                ...
                <View style={styles.hizalama}>
                    ...
                    <TouchableOpacity style={styles.toucable}
                        onPress={() => this.props.navigation.navigate('OgretmenKayit')}>
