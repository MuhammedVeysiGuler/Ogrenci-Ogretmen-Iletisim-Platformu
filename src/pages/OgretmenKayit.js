...
import {
    View, Text, StyleSheet, TextInput, Dimensions, TouchableOpacity, Image,
    StatusBar
} from 'react-native';
...
export default class OgretmenKayit extends React.Component {
        ...
        try {
            if (this.state.password.length < 6) {
                ...
                firebase.auth().createUserWithEmailAndPassword(email, password)
                    .then((res) => {
                        firebase.database().ref('Ogretmen-Kayit/id: ' + res.user.uid).set({
                ...
                this.props.navigation.navigate("OgretmenGiris")
            }
        }
        catch (error) {
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.baslikInfo}>
                    <Text style={styles.baslik}>ÖĞRETMEN KAYIT EKRANI</Text>
                </View>
                <View style={styles.textInputHizalama}>
                    ...
                    <TextInput style={styles.textInput}
                        ...
                        placeholder="Eğitim Verdiğiniz Üniversite"
                        placeholderTextColor="#FFF"
                    />
                </View>
